...
export class UserControlBase {
  ...
  private removeWindowResizeListener() {
    if (this.windowResizeHandler !== undefined) {
      this.windowRef.nativeWindow.removeEventListener('resize', this.windowResizeHandler);
    }
  }
  ...
  setupWindowResizeListener(callback: () => void) {
    ...
    this.windowRef.nativeWindow.addEventListener('resize', this.windowResizeHandler = () => {
      clearTimeout(id);
