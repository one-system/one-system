CD C:\CODE\Git.Github\one-system\one-system\one-sys\ClientApp
ng build @one-system/one-sys-core
CD dist\one-system\one-sys-core
npm pack

CD C:\CODE\Git.Github\one-system\one-system\one-sys\ClientApp
ng build @one-system/one-sys-portal-azure
CD dist\one-system\one-sys-portal-azure
npm pack

CD C:\CODE\Git.Github\one-system\one-system\one-sys\ClientApp
ng build

CD C:\CODE\Git.Github\one-system\one-system\sample1\app1\ClientApp
...
CD C:\CODE\Git.Github\one-system\one-system\sample1\app2\ClientApp
npm install ..\..\..\one-sys\clientapp\dist\one-system\one-sys-core\one-system-one-sys-core-0.0.1.tgz
npm install ..\..\..\one-sys\clientapp\dist\one-system\one-sys-portal-azure\one-system-one-sys-portal-azure-0.0.1.tgz
ng build app2
CD dist\app2
...
CD C:\CODE\Git.Github\one-system\one-system\sample1\sample-portal-1\ClientApp
npm install ..\..\..\one-sys\clientapp\dist\one-system\one-sys-core\one-system-one-sys-core-0.0.1.tgz
npm install ..\..\..\one-sys\clientapp\dist\one-system\one-sys-portal-azure\one-system-one-sys-portal-azure-0.0.1.tgz
